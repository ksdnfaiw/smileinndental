...
export default function Navbar() {
  ...
  const treatments = [
    ...
    { to: '/services/braces-and-aligners', label: 'Braces & Aligners' },
    { to: '/services/cosmetic-dentistry', label: 'Cosmetic Dentistry' },
    { to: '/services/restorative-and-general', label: 'Restorative & General' },
    { to: '/services/surgical-dentistry', label: 'Surgical Dentistry' },
    { to: '/services/child-dentistry', label: 'Child Dentistry' },
    { to: '/services/technology-and-diagnostics', label: 'Technology & Diagnostics' },
  ];

  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrolled ? 'bg-primary-container shadow-lg' : 'bg-primary-container/95'
      } backdrop-blur-md`}
    >
      <div className="flex justify-between items-center px-6 md:px-8 py-2.5 max-w-7xl mx-auto w-full">
        {/* Logo */}
        <NavLink
          to="/"
            ...
            isDropdown ? (
              ...
              >
                <NavLink
                  to={to}
                  className={({ isActive }) =>
                    `flex items-center gap-1 font-medium tracking-tight transition-all duration-300 text-lg ${
                ...
                >
                  {treatments.map((t) => (
                    <NavLink
                      ...
                      className="block px-6 py-2.5 text-slate-700 hover:bg-slate-50 hover:text-primary font-bold transition-colors"
                    >
                      {t.label}
                    </NavLink>
                  ))}
        ...
        <div className="hidden lg:flex items-center gap-6">
          <button
            ...
            className="bg-lime-500 text-slate-950 px-6 py-2 rounded-xl font-bold transition-all duration-300 hover:bg-lime-400 active:scale-95 shadow-md hover:shadow-lg"
          >
            Book Appointment
          </button>
          
          <div className="flex items-center gap-3">
            <a href="https://youtube.com/@smileinndentalclinics" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500 transition-colors">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
              </svg>
            </a>
            <a href="https://instagram.com/smileinndentalclinics" target="_blank" rel="noopener noreferrer" className="text-white hover:text-pink-500 transition-colors">
            ...
            <a href="https://facebook.com/smileinndentalclinics" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-500 transition-colors">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
