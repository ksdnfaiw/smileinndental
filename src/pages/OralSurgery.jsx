...
export default function OralSurgery() {
  ...
  const services = [
    { 
      ...
      icon: 'priority_high', 
      desc: 'Quick, pain-relieving surgical treatments to restore comfort and oral health. Specializing in difficult-to-treat acute pain.',
    ...
    { 
      title: 'Bleeding / Injury Management', 
      icon: 'healing', 
      desc: 'Immediate, expert care for oral injuries and bleeding with a focus on surgical comfort and rapid healing.',
    ...
    { 
      ...
      icon: 'broken_image', 
      desc: 'Quick and effective surgical care to repair or remove severely broken teeth and restore your oral structure.',
      image: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?q=80&w=2070&auto=format&fit=crop'
    },
    { 
      title: 'Teeth Avulsion', 
      icon: 'add_task', 
      desc: 'Immediate expert surgical care to preserve and reimplant avulsed teeth with precision and care.',
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <h1 className="text-5xl md:text-8xl font-headline text-white mb-6 leading-tight drop-shadow-lg">
            Surgical <br /><span className="italic text-secondary-fixed-dim">Precision.</span>
          </h1>
      ...
      <section className="py-24 px-6 md:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-xl text-on-surface-variant leading-relaxed">
            Our oral surgery department handles complex cases with MDS-level academic knowledge and surgical mastery. From routine extractions to advanced joint management, your safety and recovery are our primary goals.
          </p>
        </div>
